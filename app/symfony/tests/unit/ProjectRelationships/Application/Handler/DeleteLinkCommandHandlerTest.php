...
use App\ProjectRelationships\Application\Handler\DeleteLinkCommandHandler;
...
class DeleteLinkCommandHandlerTest extends TestCase
{
    ...
    public function testPositive()
    {
        ...
        $relationship = $this->getMockBuilder(Relationship::class)
            ...
            ->onlyMethods(['deleteLink', 'releaseEvents'])
            ->getMock();
        ...
        $handler = new DeleteLinkCommandHandler(
            $relationshipRepository,
            $eventBus
        );
        $command = new DeleteLinkCommand($fromTaskId, $toTaskId, $userId);
